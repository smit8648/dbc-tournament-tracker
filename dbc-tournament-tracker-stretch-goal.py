...
def searchByName(player_name, player_list):
    if player_name in player_list:
        playerIndex = int(player_list.index(player_name)) + 1
        print(f"{playerIndex} is the position of {player_name}")
...
def menu():
    ...
    while flag:
        ...
        if choice == 1:
            ...
            nameSearch = input("What is the name of the player? ")
            searchByName(nameSearch, player_list)
        elif choice == 5:
